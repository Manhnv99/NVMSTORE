package com.nvm.nvmstore.service.voucher.serviceImpl;
...
import com.nvm.nvmstore.service.voucher.VoucherService;
...
public class VoucherServiceImpl implements VoucherService {
    ...
    public String PostVoucher(VoucherPostRequest voucherPostRequest) {
        ...
        Integer status=checkStatusVoucher.CheckStatus(voucherPostRequest.getDate_start(),voucherPostRequest.getDate_end());
    ...
    public String PutVoucher(VoucherPutRequest voucherPutRequest) {
        ...
        voucherOptional.ifPresent(putVoucher -> {
            ...
            Integer status=checkStatusVoucher.CheckStatus(voucherPutRequest.getDate_start(),voucherPutRequest.getDate_end());
    ...
    //SearchVoucherPaging
    @Override
    public List<GetAllVoucherResponse> searchVoucherPaging(String code, Integer quantity, BigDecimal value, Integer status, String date_start,
    ...
    @Override
    public Double getToTalPageSearchVoucher(String code, Integer quantity, BigDecimal value, Integer status, String date_start, String date_end,Integer limit) {

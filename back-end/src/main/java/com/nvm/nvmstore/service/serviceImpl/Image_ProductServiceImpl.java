...
public class Image_ProductServiceImpl implements Image_ProductService {
    ...
    @Override
    public void addImageProduct(ImageProductRequest imageProductRequest) throws IOException {
        Image_Product image_product_add=new Image_Product();
        Map result=cloudinaryService.upload(imageProductRequest.getImage());
        ...
        image_product_add.setImage_id((String) result.get("public_id"));
        image_product_add.setImage_url((String) result.get("url"));

package com.nvm.nvmstore.core.material.service.serviceImpl;

import com.nvm.nvmstore.core.material.repository.DBMaterialRepository;
...
public class MaterialServiceImpl implements MaterialService {
    ...
    @Autowired
    private DBMaterialRepository materialRepository;
    ...
    @Override
    public List<MaterialResponse> searchMaterial(String input, Entity_Status status, Pageable pageable) {
    ...
    public void updateMaterial(Long id, MaterialRequest materialRequest) {
        ...
        optionalMaterial.get().setStatus(materialRequest.getStatus());

package com.nvm.nvmstore.core.brand.controller;
...
public class BrandController {
    ...
    public ResponseEntity<?> searchBrand(@RequestParam(name = "input",required = false) String input, @RequestParam(name = "status",required = false) Entity_Status status, @PathVariable Integer page){
        PageRequest pageRequest=PageRequest.of(page-1,3);

package com.nvm.nvmstore.core.staff.service.serviceImpl;
...
import com.nvm.nvmstore.infrastructure.config.email.EmailService;
...
public class StaffServiceImpl implements StaffService {
    ...
    public ResponseEntity<?> postStaff(PostStaffRequest postStaffRequest) throws IOException {
        ...
        staffAdd.setRole(Role.ADMIN);
        staffAdd.setStatus(postStaffRequest.getStatus());
    ...
    public ResponseEntity<?> putStaff(Long id, PutStaffRequest putStaffRequest) throws IOException {
        ...
        staffOptional.get().setStatus(putStaffRequest.getStatus());
    ...
    @Override
    public List<StaffResponse> searchStaff(String input, Staff_Status status, Pageable pageable) {
        return staffRepository.searchStaff(input,status,pageable);
    }

    @Override
    public Double getTotalPageSearch(String input, Staff_Status status) {
